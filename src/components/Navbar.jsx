  ...
  const videoTools = [
    {
      ...
      link: "/compressor",
      icon: "📉",
      desc: "Compress video size locally",
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link
              href="/"
              className="text-lg font-black tracking-tight text-slate-900 dark:text-white flex items-center gap-2 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            <Link
              href="/"
              className="hidden sm:inline-block text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-gray-300 hover:text-blue-500 transition-colors"
            >
              Home
            </Link>
            ...
            <div className="relative group py-5" ref={dropdownRef}>
              ...
              >
                All Tools
                <span className="text-[9px] transition-transform duration-200 group-hover:rotate-180 block pt-0.5">
                  ▼
                </span>
              </button>
        ...
        <div className="bg-white dark:bg-[#0a0a0a] border-t border-slate-200 dark:border-white/5 max-h-[85vh] overflow-y-auto animate-in slide-in-from-top duration-200">
          <div className="px-3 pt-2 pb-5 space-y-1 text-center">
            <Link
              ...
              className="block px-3 py-2 rounded-xl text-sm font-bold uppercase text-slate-700 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5 transition-all"
            >
              Home
            </Link>
            ...
            <Link
              href="/about"
              onClick={() => setIsOpen(false)}
              className="block px-3 py-2.5 rounded-xl text-sm font-bold uppercase text-slate-700 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5 transition-all"
            >
              About Us
            </Link>
            <Link
