export const metadata = {
  ...
  keywords: [
    ...
    "twitter thread generator online",
    "instagram reels text hook generator",
    "hold to read video text trigger",
...
export default function SocialTextChunkerLayout({ children }) {
  return <>{children}</>;
}